...
count_vector = CountVectorizer(lowercase=False, token_pattern=r'[/\-$%a-zA-z0-9]{2,}', max_features=1000)
string1 = r'-{2,}|~|\.{3,}'
string2 = r'<.*?>'
...
DT = DecisionTreeClassifier(min_samples_leaf=0.01, criterion='entropy', random_state=0)
